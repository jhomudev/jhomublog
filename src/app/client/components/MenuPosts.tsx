...
import { CATEGORIE_COLORS, CatColors, DEFAULT_POST_IMG } from "../data"
import { formatDate } from "../libs/utils"
import { PostInPosts } from "../types"
import MenuPostsSkeleton from "./MenuPostsSkeleton"
...
function MenuPosts({ withImage = false, dataPost:{isLoading, posts} }: Props) {
  const hasPosts = posts.length > 0

  if (isLoading) return <MenuPostsSkeleton />
